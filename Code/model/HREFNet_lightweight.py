...
class HREFNet_lightweightModule(nn.Module):
    def __init__(
            self,
            num_branches,
            blocks,
        ...
        super(HREFNet_lightweightModule, self).__init__()
...
class HREFNet_lightweight(nn.Module):
    def __init__(self, cfg,  **kwargs):
        super(HREFNet_lightweight, self).__init__()
    ...
    def forward(self, x):
        ...
        y = torch.cat([y_list[0], x1, fusion],1)
...
class MREF(nn.Module):
    def __init__(self, channel, norm='gn', flag=0):
        ...
        self.conv2561 = nn.Conv2d(256, 36, kernel_size=1)
        self.conv128 = nn.ConvTranspose2d(72, 36, kernel_size=4, stride=2, padding=1)
